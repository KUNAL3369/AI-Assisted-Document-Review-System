      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign up to get started with Document Review
          </p>
        </div>
        ...
        {success ? (
          <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-lg p-6 text-center space-y-3">
            ...
            <Link
              href="/login"
              className="inline-block mt-2 text-sm font-medium text-emerald-700 hover:text-emerald-600 underline underline-offset-2"
            >
              Go to sign in
            </Link>
          </div>
